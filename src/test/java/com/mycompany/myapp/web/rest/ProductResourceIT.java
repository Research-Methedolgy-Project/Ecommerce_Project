...
class ProductResourceIT {
    ...
    private static final Long DEFAULT_REMAINING_STOCK = 1L;
    private static final Long UPDATED_REMAINING_STOCK = 2L;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .remaining_stock(DEFAULT_REMAINING_STOCK)
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getRemaining_stock()).isEqualTo(DEFAULT_REMAINING_STOCK);
        assertThat(testProduct.getAdded_date()).isEqualTo(DEFAULT_ADDED_DATE);
    }
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].remaining_stock").value(hasItem(DEFAULT_REMAINING_STOCK.intValue())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.remaining_stock").value(DEFAULT_REMAINING_STOCK.intValue()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getRemaining_stock()).isEqualTo(UPDATED_REMAINING_STOCK);
        assertThat(testProduct.getAdded_date()).isEqualTo(UPDATED_ADDED_DATE);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.remaining_stock(UPDATED_REMAINING_STOCK);
